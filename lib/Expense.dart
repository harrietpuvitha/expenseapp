...
class _ExpensepageState extends State<Expensepage> {
  ...
  void initState() {
    super.initState();
    for(final price in expenseList.value){
          ...
          children: [
            Expanded(
              child: Container(
                ...
                child: expenseList.value.isNotEmpty ? ValueListenableBuilder(
                          ...
                          return Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Container(
                                    child: Text(expenseList.value[Index].title
                                        .toString()),
                                  ),
                                ),
                                SizedBox(width: 10,),
                                Expanded(
                                  child: Container(
                                      child: Text(
                                          expenseList.value[Index].category.toString())),
                                ),
                                SizedBox(width: 10,),
                                Expanded(
                                    child: Container(
